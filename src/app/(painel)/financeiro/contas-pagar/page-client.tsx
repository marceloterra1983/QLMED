              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b border-slate-100 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-800/30">
                    ...
                    >
                      <div className="flex items-center">Fornecedor <SortIcon col="emitente" /></div>
                    </th>
                    <th
                      className="text-left px-4 py-3 font-semibold text-slate-500 dark:text-slate-400 cursor-pointer hover:text-primary select-none"
                      ...
                      {!collapsedGroups.has(group) && (
                        ...
                        >
                          ...
                          <div className="flex items-center justify-between mt-2 pt-2 border-t border-slate-100 dark:border-slate-800">
                            <div className="flex items-center gap-2">
                              <span className="text-sm font-bold font-mono text-red-500 dark:text-red-400">{formatCurrency(dup.dupValor)}</span>
