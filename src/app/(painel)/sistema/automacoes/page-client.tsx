...
/**
 * SPEC-046: Automações (status n8n) aposentada. A rota permanece para
  ...
  return (
    <div className="space-y-6">
      ...
      <EmptyState
        ...
        hint="Os workflows do n8n foram migrados ou desligados (SPEC-046). Consulte Rotinas para o Resumo Diário NF-e e demais jobs do portal."
        action={
