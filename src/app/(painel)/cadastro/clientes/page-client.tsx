              ...
              {loading ? (
                Array.from({ length: limit }).map((_, index) => (
                  <tr key={index}>
                    ...
                    <td className="px-4 py-1"><Skeleton className="h-4 w-28" /></td>
                      ...
                      <React.Fragment key={`${customer.cnpj}-${customer.name}`}>
                        {showDivider && (
                          <tr className="cursor-pointer select-none" onClick={() => toggleGroup(group)}>
                            <td colSpan={5} className="px-4 py-1.5 bg-slate-100/80 dark:bg-slate-800/60 border-y border-slate-200 dark:border-slate-700">
                          ...
                          <tr className="hover:bg-slate-50 dark:hover:bg-slate-800/40 transition-colors cursor-pointer" onClick={() => { setSelectedCustomer(customer); setIsDetailsOpen(true); }}>
                            ...
                            <td className="px-4 py-1">
                              {(() => {
                                ...
                                const display = customer.shortName
                                  ? customer.shortName
                                  : isCpf
                            ...
                            <td className="px-4 py-1"><span className="text-[12px] text-slate-600 dark:text-slate-300">{customer.city || '-'}</span></td>
