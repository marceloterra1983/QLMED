...
export default function SupplierPriceTableModal({ isOpen, onClose, supplier }: SupplierPriceTableModalProps) {
  ...
  const [detailRow, setDetailRow] = useState<SupplierPriceRow | null>(null);
      ...
      {!loading && details && (
        <div className="space-y-3">
          <div className="rounded-lg border border-slate-200 dark:border-slate-800 bg-slate-50/70 dark:bg-slate-900/30 px-3 py-2">
            <p className="text-sm font-semibold text-slate-900 dark:text-white">{supplierDisplayName}</p>
            ...
            <div className="space-y-3">
              ...
              <div className="rounded-xl border border-slate-200 dark:border-slate-800 divide-y divide-slate-200 dark:divide-slate-800">
                ...
                <div className="px-4 py-3 grid grid-cols-2 gap-x-6 gap-y-2">
                  ...
                  <div>
                    <p className="text-[10px] uppercase tracking-wide text-slate-400 font-medium">Último Preço de Compra</p>
                    <p className="text-sm font-bold text-slate-900 dark:text-white">{formatPrice(detailRow.lastPrice)}</p>
                  </div>
                  <div>
                    <p className="text-[10px] uppercase tracking-wide text-slate-400 font-medium">Última Compra</p>
