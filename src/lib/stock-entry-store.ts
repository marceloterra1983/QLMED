...
export async function upsertStockEntry(input: UpsertStockEntryInput): Promise<StockEntryRow> {
  ...
  if (existing) {
    const updated = await prisma.stockEntry.update({
      ...
      data: {
        ...
        totalValueDecimal: toMoneyDecimal(input.totalValue ?? existing.totalValue),
        totalItems,
        matchedItems,
        status,
        registeredAt,
  ...
  const created = await prisma.stockEntry.create({
    data: {
      ...
      totalValueDecimal: toMoneyDecimal(input.totalValue ?? null),
      totalItems,
      matchedItems,
      status,
      registeredAt,
...
export async function updateStockEntryFiscalTotals(
  ...
  await prisma.stockEntry.updateMany({
    ...
    data: {
      ...
      totVprodDecimal: toMoneyDecimal(data.totVprod ?? null),
      totVdesc: data.totVdesc ?? null,
      totVdescDecimal: toMoneyDecimal(data.totVdesc ?? null),
      totVbc: data.totVbc ?? null,
      totVbcDecimal: toMoneyDecimal(data.totVbc ?? null),
      totVicms: data.totVicms ?? null,
      totVicmsDecimal: toMoneyDecimal(data.totVicms ?? null),
      totVbcSt: data.totVbcSt ?? null,
      totVbcStDecimal: toMoneyDecimal(data.totVbcSt ?? null),
      totVicmsSt: data.totVicmsSt ?? null,
      totVicmsStDecimal: toMoneyDecimal(data.totVicmsSt ?? null),
      totVfrete: data.totVfrete ?? null,
      totVfreteDecimal: toMoneyDecimal(data.totVfrete ?? null),
      totVseg: data.totVseg ?? null,
      totVsegDecimal: toMoneyDecimal(data.totVseg ?? null),
      totVoutro: data.totVoutro ?? null,
      totVoutroDecimal: toMoneyDecimal(data.totVoutro ?? null),
      totVipi: data.totVipi ?? null,
      totVipiDecimal: toMoneyDecimal(data.totVipi ?? null),
      totVpis: data.totVpis ?? null,
      totVpisDecimal: toMoneyDecimal(data.totVpis ?? null),
      totVcofins: data.totVcofins ?? null,
      totVcofinsDecimal: toMoneyDecimal(data.totVcofins ?? null),
      totVfcp: data.totVfcp ?? null,
      totVfcpDecimal: toMoneyDecimal(data.totVfcp ?? null),
      totVnf: data.totVnf ?? null,
      totVnfDecimal: toMoneyDecimal(data.totVnf ?? null),
      updatedAt: new Date(),
    },
  });
}
...
function toNfeCreateData(item: NfeEntryItemInput) {
  return {
    ...
    unitPriceDecimal: toMoneyDecimal(item.unitPrice ?? 0),
    totalValueGross: item.totalValueGross ?? 0,
    totalValueGrossDecimal: toMoneyDecimal(item.totalValueGross ?? 0),
    itemDiscount: item.itemDiscount ?? 0,
    itemDiscountDecimal: toMoneyDecimal(item.itemDiscount ?? 0),
    totalValueNet: item.totalValueNet ?? 0,
    totalValueNetDecimal: toMoneyDecimal(item.totalValueNet ?? 0),
    ...
    rateioFreteDecimal: toMoneyDecimal(item.rateioFrete ?? 0),
    rateioSeguro: item.rateioSeguro ?? 0,
    rateioSeguroDecimal: toMoneyDecimal(item.rateioSeguro ?? 0),
    rateioOutrasDesp: item.rateioOutrasDesp ?? 0,
    rateioOutrasDespDecimal: toMoneyDecimal(item.rateioOutrasDesp ?? 0),
    rateioDesconto: item.rateioDesconto ?? 0,
    rateioDescontoDecimal: toMoneyDecimal(item.rateioDesconto ?? 0),
    lot: item.lot ?? null,
...
export async function cloneNfeEntryItemBatch(
  ...
  const created = await prisma.nfeEntryItem.create({
    data: {
      ...
      rateioFreteDecimal: toMoneyDecimal(source.rateioFrete),
      rateioSeguro: source.rateioSeguro,
      rateioSeguroDecimal: toMoneyDecimal(source.rateioSeguro),
      rateioOutrasDesp: source.rateioOutrasDesp,
      rateioOutrasDespDecimal: toMoneyDecimal(source.rateioOutrasDesp),
      rateioDesconto: source.rateioDesconto,
      rateioDescontoDecimal: toMoneyDecimal(source.rateioDesconto),
      lot: data.lot,
