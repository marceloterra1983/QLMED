...
- [x] G7: AFE continua sem gravar a data da consulta; certidão inalterada
  CHECK: npx vitest run src/lib/__tests__/documentos-ingest.test.ts -t "AFE com data de consulta" src/lib/__tests__/documentos-classify.test.ts -t "a fixture tem 24 nomes" > /dev/null 2>&1 && echo OK_G7
  EXPECT: OK_G7
  EVIDENCE: OK_G7 (AFE validUntil null; fixture 24 nomes)
